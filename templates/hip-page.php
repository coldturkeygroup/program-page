        ...
        <div class="row">
          <div class="col-xs-12 col-md-11 col-lg-10 center-block text-center">
            <div class="inner">
              ...
              <p class="banner-text role-element leadstyle-text">&nbsp;A new home buyer discount for <?= $state ?> healthcare professionals.</p>
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-xs-12 col-md-11 col-lg-10 center-block">
          ...
          <p class="role-element leadstyle-text">The HIP Program has already helped healthcare professionals in <?= $program_area['county'] ?> save thousands of dollars on their home purchases.</p>
        </div>
      </div>
      <div class="row">
          <?php if ($test_1_name != '') { ?>
    ...
    <div class="row">
      <div class="col-xs-12 text-center">
        <ul class="faq-list role-element leadstyle-text">
          <li>
            <span style="color: #46bec2; "><b>Is this only for first time home buyers?</b></span><br>Absolutely not! If you’re currently employed in the healthcare industry, you can qualify for the HIP discount. Even if you currently own a home, your next home purchase (in the state of <?= $state ?>) could be eligible for the HIP credit.
          </li>
          <li>
          ...
          <li>
            <span style="color: #46bec2; "><b>Is there a purchase price limitation?</b></span><br>No way! The HIP program was designed to encourage higher rates of home ownership for healthcare professionals here in <?= $program_area['city'] ?>. Unlike some other programs, there are no limits on the price of home you can purchase.
          </li>
          <li>
            <span style="color: #46bec2; "><b>How long does it take to apply?</b></span><br>The HIP discount does not require extensive paperwork or applications. Most home buyers find out within 12 hours if they will qualify for the discount.
          </li>
          <li>
            <span style="color: #46bec2; "><b>How much money can I save with the HIP discount?</b></span><br>The exact number varies, but most home buyers in <?= $program_area['city'] ?> can expect to save around $<?= $expected_savings ?> (or more). This discount can be combined with other mortgage programs to save even more!
          </li>
        </ul>
      </div>
    </div>
