...
<head>
    ...
    <?php wp_head(); ?>
    <link rel="apple-touch-icon" sizes="180x180" href="https://cdn.platform.marketing/assets/programs/path/apple-touch-icon.png">
    <link rel="icon" type="image/png" href="https://cdn.platform.marketing/assets/programs/path/favicon-32x32.png" sizes="32x32">
    <link rel="icon" type="image/png" href="https://cdn.platform.marketing/assets/programs/path/favicon-16x16.png" sizes="16x16">
    <link rel="manifest" href="https://cdn.platform.marketing/assets/programs/path/manifest.json">
    <link rel="mask-icon" href="https://cdn.platform.marketing/assets/programs/path/safari-pinned-tab.svg" color="#5bbad5">
