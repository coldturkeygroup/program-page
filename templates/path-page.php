    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-xs-12 col-md-11 col-lg-10 center-block">
          ...
          <p class="role-element leadstyle-text">The PATH Program has already helped the community in <?= $program_area['county'] ?> save thousands of dollars on their home purchases.</p>
        </div>
      </div>
      <div class="row">
          <?php if ($test_1_name != '') { ?>
    ...
    <div class="row">
      <div class="col-xs-12 text-center">
        <ul class="faq-list role-element leadstyle-text">
          ...
          <li>
            <span style="color: #46bec2; "><b>Are there income or credit requirements for the PATH Program?</b></span><br>No. The PATH Program is an independent discount for educators and public servants here in <?= $state ?>. It is
            <em>not</em> a mortgage program; therefore, there are no income or credit qualifications! You can apply the PATH discount to whatever financing or mortgage product you qualify for.
          </li>
          <li>
            <span style="color: #46bec2; "><b>Is there a purchase price limitation?</b></span><br>No way! The PATH Program was designed to encourage higher rates of home ownership for educators and public servants here in <?= $program_area['city'] ?>. Unlike some other programs, there are no limits on the price of home you can purchase.
          </li>
          <li>
          ...
          <li>
            <span style="color: #46bec2; "><b>How much money can I save with the PATH Program?</b></span><br>The exact number varies, but most home buyers in <?= $program_area['city'] ?> can expect to save around $<?= $expected_savings ?> (or more). This discount can be combined with other mortgage programs to save even more!
          </li>
        </ul>
      </div>
    </div>
