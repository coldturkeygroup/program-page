<?php
/**
 * Template file for displaying BOOST Program Page
 *
 * @package    WordPress
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1, minimum-scale=1, maximum-scale=1, user-scalable=no">
    <?php wp_head(); ?>
  <link rel="apple-touch-icon" sizes="180x180" href="https://cdn.platform.marketing/assets/programs/boost/favicons/apple-touch-icon.png">
  <link rel="icon" type="image/png" href="https://cdn.platform.marketing/assets/programs/boost/favicons/favicon-32x32.png" sizes="32x32">
  <link rel="icon" type="image/png" href="https://cdn.platform.marketing/assets/programs/boost/favicons/favicon-16x16.png" sizes="16x16">
  <link rel="manifest" href="https://cdn.platform.marketing/assets/programs/boost/favicons/manifest.json">
  <link rel="mask-icon" href="https://cdn.platform.marketing/assets/programs/boost/favicons/safari-pinned-tab.svg" color="#5bbad5">
...
<div class="wrapper wrapper-bg-banner wrapper-center-block banner role-element leadstyle-container">
  <div class="bg-wrapper">
    <img src="https://cdn.platform.marketing/assets/programs/boost/boost-background.jpg" class="role-element leadstyle-background-image">
  </div>
        ...
        <div class="row">
          <div class="col-xs-12 col-md-11 col-lg-10 center-block text-center">
            <div class="inner">
              ...
              <p class="banner-text role-element leadstyle-text">&nbsp;A new home buyer discount for <?= $state ?> residents.</p>
      ...
      <div class="col-xs-12 <?php if ($video_url != '') {
        ...
        <div class="<?php if ($video_url != '') {
          ...
          <h2 class="text-xs-center text-sm-center <?php if ($video_url == '') {
            ...
            <strong><span style="color:#6818a5">&lt;</span> What is the <?= $state ?> BOOST program?&nbsp;<span style="color:#6818a5">&gt;</span></strong>
          </h2>
          <p class="role-element leadstyle-text">We’re excited to announce a new program that will benefit the great people here in <?= $program_area['city'] ?>: the <?= $state ?> BOOST Program. We want to give back to help BOOST these individuals to home ownership!<br><br>We want to help mitigate the home buying cost for our local residents!<br><br><span style="font-weight: 700;">We want to say thank you. The BOOST Program is a special home buyer credit.</span> It is a <em>free credit</em> that will reduce the amount of money that is owed at closing time.<br><br>This special credit will make the American dream of home ownership more affordable for the hardworking every day people that help make <?= $program_area['county'] ?> what it is.<br><br><span style="font-weight: 700;">You do NOT have to be a first time home buyer to apply for these special credits!</span>
          </p>
        </div>
      </div>
        <?php if ($video_url != '') { ?>
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-xs-12 col-md-11 col-lg-10 center-block">
          ...
          <p class="role-element leadstyle-text">The BOOST Program has already helped the community in <?= $program_area['county'] ?> save thousands of dollars on their home purchases.</p>
        </div>
      </div>
      <div class="row">
          <?php if ($test_1_name != '') { ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-md-11 col-lg-10 center-block text-center">
        ...
        <p class="role-element leadstyle-text">These are the most common questions about the <?= $state ?> BOOST Program. For more information call <?= $phone ?></p>
      </div>
    </div>
    <div class="row">
      <div class="col-xs-12 text-center">
        <ul class="faq-list role-element leadstyle-text">
          <li>
            <span style="color: #46bec2; "><b>Is this only for first time home buyers?</b></span><br>Absolutely not! Even if you've already purchased a home, you can qualify for the BOOST discount. Your next home purchase (in the state of <?= $state ?>) could be eligible for the BOOST credit.
          </li>
          <li>
            <span style="color: #46bec2; "><b>Are there any application or up-front fees?</b></span><br>NO. There are NEVER any up-front or application fees for the BOOST program.
          </li>
          <li>
            <span style="color: #46bec2; "><b>Can I only buy certain homes?</b></span><br>No! You may use the BOOST discount to purchase any home on the market as long as it is within the guidelines of your loan approval.
          </li>
          <li>
            <span style="color: #46bec2; "><b>Can I combine this discount with other programs?&nbsp;</b></span><br>Definitely. The BOOST Program is technically not a mortgage program (it is an independent discount). This means you can apply the discount on top of any other programs you may be eligible for (FHA loans, first time home buyer programs, etc).
          </li>
          <li>
            <span style="color: #46bec2; "><b>Are there income or credit requirements for the BOOST Program?</b></span><br>No. The BOOST Program is an independent discount for everyone here in <?= $state ?>. It is <em>not</em> a mortgage program; therefore, there are no income or credit qualifications! You can apply the BOOST discount to whatever financing or mortgage product you qualify for.
          </li>
          <li>
            <span style="color: #46bec2; "><b>Is there a purchase price limitation?</b></span><br>No way! The BOOST Program was designed to encourage higher rates of home ownership for everyone here in <?= $program_area['city'] ?>. Unlike some other programs, there are no limits on the price of home you can purchase.
          </li>
          <li>
            <span style="color: #46bec2; "><b>How long does it take to apply?</b></span><br>The BOOST discount does not require extensive paperwork or applications. Most home buyers find out within 12 hours if they will qualify for the discount.
          </li>
          <li>
            <span style="color: #46bec2; "><b>How much money can I save with the BOOST Program?</b></span><br>The exact number varies, but most home buyers in <?= $program_area['city'] ?> can expect to save around $<?= $expected_savings ?> (or more). This discount can be combined with other mortgage programs to save even more!
          </li>
        </ul>
      </div>
    </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="hipInfoLabel">Get Started With The BOOST Discount</h4>
      </div>
      <div class="modal-body">
        Call or text <?= $phone ?> to apply for the BOOST home buyer discount
      </div>
