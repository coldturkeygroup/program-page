        ...
        <div class="row">
          <div class="col-xs-12 col-md-11 col-lg-10 center-block text-center">
            <div class="inner">
              ...
              <p class="banner-text role-element leadstyle-text">&nbsp;A new home buyer discount for <?= $state ?> veterans and military members.</p>
      ...
      <div class="col-xs-12 <?php if ($video_url != '') {
        ...
        <div class="<?php if ($video_url != '') {
          ...
          <ul>
            ...
            <?php } ?>
          <br>This special credit will make the American dream of home ownership more affordable for the hardworking military and veteran community that serve us here in <?= $program_area['county'] ?>.<br><br><span style="font-weight: 700;">You do NOT have to be a first time home buyer to apply for these special credits!</span>
          </p>
        </div>
      </div>
        <?php if ($video_url != '') { ?>
    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-xs-12 col-md-11 col-lg-10 center-block">
          ...
          <p class="role-element leadstyle-text">The Patriot Program has already helped the military and veteran community in <?= $program_area['county'] ?> save thousands of dollars on their home purchases.</p>
        </div>
      </div>
      <div class="row">
          <?php if ($test_1_name != '') { ?>
    ...
    <div class="row">
      <div class="col-xs-12 text-center">
        <ul class="faq-list role-element leadstyle-text">
          ...
          <li>
            <span style="color: #46bec2; "><b>Is there a purchase price limitation?</b></span><br>No way! The Patriot program was designed to encourage higher rates of home ownership for military members and vets here in <?= $program_area['city'] ?>. Unlike some other programs, there are no limits on the price of home you can purchase.
          </li>
          <li>
            <span style="color: #46bec2; "><b>How long does it take to apply?</b></span><br>The Patriot discount does not require extensive paperwork or applications. Most home buyers find out within 12 hours if they will qualify for the discount.
          </li>
          <li>
            <span style="color: #46bec2; "><b>How much money can I save with the Patriot Program?</b></span><br>The exact number varies, but most home buyers in <?= $program_area['city'] ?> can expect to save around $<?= $expected_savings ?> (or more). This discount can be combined with other mortgage programs to save even more!
          </li>
        </ul>
      </div>
    </div>
