                ...
                <div class="row">
                    <div class="col-xs-12 col-md-11 col-lg-10 center-block text-center">
                        <div class="inner">
                            ...
                            <p class="banner-text role-element leadstyle-text">&nbsp;A new homebuyer discount for <?= $state ?> first responders.</p>
        ...
        <div class="row text-center">
            <div class="col-xs-12 <?php if ($video_url != '') {
                ...
                <div class="<?php if ($video_url != '') {
                    ...
                    <p class="role-element leadstyle-text">We’re excited to announce a new program that will benefit the first responders here in the greater <?= $city ?> area: the <?= $state ?> First Responders Program.<br><br>As a society, we typically honor public servants like teachers, military members, and nurses. And we should... these heroes are true public servants! But sometimes we forget that first responders are also public servants! They work long, difficult hours to protect our freedom 24/7/365.<br><br><span style="font-weight: 700;">We want to say thank you. The First Responders Program is a special homebuyer credit.</span> It is multiple discounts that are applied to your loan and closing costs—it is NOT a loan. It is a
                      <em>free credit</em> that will reduce the amount of money that is owed at closing time. The discounts include:
                    <ul><li>Discounted Appraisal</li><li>Discounted Home Inspection</li><li>Reduced Closing Costs</li><li>Additional Money Towards Closing Costs or Moving Expenses</li></ul>
                  <br>This special credit will make the American dream of home ownership more affordable for the hardworking first responders that serve us here in <?= $program_area ?>.<br><br><span style="font-weight: 700;">You do NOT have to be a first time homebuyer to apply for these special credits!</span>
                    </p>
                </div>
            </div>
            <?php if ($video_url != '') { ?>
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-xs-12 col-md-11 col-lg-10 center-block">
                    ...
                    <p class="role-element leadstyle-text">The First Responders Program has already helped the community in <?= $program_area ?> save thousands of dollars on their home purchases.</p>
                </div>
            </div>
            <div class="row">
                <?php if ($test_1_name != '') { ?>
        ...
        <div class="row">
            <div class="col-xs-12 text-center">
                <ul class="faq-list role-element leadstyle-text">
                    ...
                    <li>
                        <span style="color: #46bec2; "><b>Is there a purchase price limitation?</b></span><br>No way! The First Responders Program was designed to encourage higher rates of homeownership for first responders here in the <?= $city ?> area. Unlike some other programs, there are no limits on the price of home you can purchase.
                    </li>
                    <li>
                        <span style="color: #46bec2; "><b>How long does it take to apply?</b></span><br>The First Responders discount does not require extensive paperwork or applications. Most homebuyers find out within 12 hours if they will qualify for the discount.
                    </li>
                    <li>
                        <span style="color: #46bec2; "><b>How much money can I save with the First Responders Program?</b></span><br>The exact number varies, but most homebuyers in the <?= $city ?> area can expect to save around $<?= $expected_savings ?> (or more). This discount can be combined with other mortgage programs to save even more!
                    </li>
                </ul>
            </div>
        </div>
